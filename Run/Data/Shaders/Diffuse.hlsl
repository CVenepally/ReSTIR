...
Texture2D       sgeTexture : register(t2, space0);
...
//------------------------------------------------------------------------------------------------
//cbuffer DebugConstants : register(b1, space0)
//{
//    float   debugTime;
//    int     debugInt;
//    float   debugFloat;
...
//------------------------------------------------------------------------------------------------
cbuffer LightConstants : register(b4, space0)
{
...
{    
    float4 diffuseTexel     = diffuseTexture.Sample(samplers, pixelIn.pi_texCoords);
    float4 normalTexel      = normalTexture.Sample(samplers, pixelIn.pi_texCoords);
    float4 sgeTexel         = sgeTexture.Sample(samplers, pixelIn.pi_texCoords);
